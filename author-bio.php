...
<div class="author-info
	...
	<div class="row">
		<div class="col-sm-12">
			<h2>
				<?php
					echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'solace_digital_author_bio_avatar_size', 48 ) ) . '&nbsp;';
					printf( esc_html__( 'About %s', 'solace-digital' ), get_the_author() );
				?>
			</h2>
			...
			<p class="author-links">
				...
				if ( ! empty( get_the_author_meta( 'user_url' ) ) ) {
					printf( '<a href="%s" class="www btn btn-secondary btn-sm">' . esc_html__( 'Website', 'solace-digital' ) . '</a>', esc_url( get_the_author_meta( 'user_url' ) ) );
				}
